...
export const PhilosopherList = ({
  ...
  if (philosophers.length === 0) {
    return (
      <MotionDiv className="w-full py-12 text-center">
        <MotionHeading2
  ...
  return (
    <MotionSection className="flex w-full flex-col items-center">
      <MotionDiv className="mx-auto flex w-full max-w-7xl flex-wrap justify-center gap-6">
